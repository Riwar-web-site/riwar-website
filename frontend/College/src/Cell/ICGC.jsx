...
function ICGC() {
  ...
  const galleryImages = [
    'https://source.unsplash.com/300x200/?startup,people',
    'https://source.unsplash.com/300x200/?entrepreneur',
    'https://source.unsplash.com/300x200/?teamwork,innovation',
    'https://source.unsplash.com/300x200/?meeting',
    'https://source.unsplash.com/300x200/?presentation'
  ];

  return (
    <div className="edc-section py-5 bg-light">
      <Container>
        <h1 className="text-center mb-5 display-4 fw-bold animate-soft-glow">🚀 ICGC Development Cell</h1>
                  ...
                  {section.title === 'Photo Gallery' && (
                    <Row className="g-3 mt-3">
                      {galleryImages.map((src, i) => (
                        <Col xs={6} sm={4} key={i} className="zoom-in">
                          <img src={src} alt={`Gallery ${i + 1}`} className="img-fluid rounded gallery-img shadow-sm" />
                        </Col>
                      ))}
                    </Row>
                  )}
