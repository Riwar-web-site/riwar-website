...
function SportDevelopmentCell() {
  ...
  return (
    <div className="edc-section py-5 bg-light uni   ">
      <Container>
        <h1 className="text-center mb-5 display-4 fw-bold animate-glow"> ⚽Sport Development Cell ⚽</h1>
...
export default SportDevelopmentCell;
