...
function HealthCareCommittee() {
  ...
  return (
    <div className="grievance-section py-5 bg-light animate__animated animate__fadeIn uni">
      <Container>
        <h1 className="text-center mb-5 display-5 fw-bold text-primary soft-glow"> 👨‍⚕️  Health Care Commitee</h1>
...
export default HealthCareCommittee;
