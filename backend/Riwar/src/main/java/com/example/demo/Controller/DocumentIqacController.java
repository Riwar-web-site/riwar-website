...
import com.example.demo.Service.DocumentIqacService;



@RestController
@CrossOrigin
@RequestMapping("/doc-iqac")
public class DocumentIqacController {

	
@Autowired
private  DocumentIqacService ds;
...
public ResponseEntity<byte[]> downloadPdf(@PathVariable Long id) {
	    DocumentIqac file = ds.getPdfById(id);
